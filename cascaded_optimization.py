...
from cervix_inflation_EX_V2_original import make_selections
...
OPTIMIZATIONS = {
    ...
    "cervix_inflation_EX_V2_original": {
        "base_path": "cervix_inflation_EX_V2_original",
        "state_path": "state_MR_Conradlow.json",
        "run_path": "run_MR_Conradlow.json",
        "num_control_points": {
            "0": [6, 12, 24, 48, 96, 192, 384, 768]
        },
        "num_iters": [10, 10, 10, 10, 10, 10, 10, 10],
