...
from cervix_inflation_EX_V2_original_dual_deformed_fine import make_selections
...
OPTIMIZATIONS = {
    ...
    "cervix_inflation_EX_V2_original_dual_fine": {
        "base_path": "cervix_inflation_EX_V2_original_dual_fine",
        "state_path": "state_MR_Conradlow.json",
        "run_path": "run_MR_Conradlow_dual.json",
        "num_control_points": {
            "0": [6, 12, 24, 48, 96, -1, -1]
        },
        "num_iters": [10, 10, 10, 10, 10, 10, 10],
        "aux_files": ["LORIP45V2_UTCX_scaled_out.obj", "LORIP45V2_CX.stl", "LORIP45V2_UTCX_scaled_in.obj"],
        "opt_mesh_idx": 0,
        "remesh_reload_function": lambda fname: make_selections.make_selections(fname, "LORIP45V2_CX.stl"),
        "threads": 16
    },
    "cervix_inflation_EX_V2_original_dual_deformed_fine": {
        "base_path": "cervix_inflation_EX_V2_original_dual_deformed_fine",
        "state_path": "state_MR_Conradlow.json",
        "run_path": "run_MR_Conradlow_dual.json",
        "num_control_points": {
            "0": [6, 12, 24, 48, 96, 192, 384, -1, -1]
        },
        "num_iters": [10, 10, 10, 10, 10, 10, 10, 10, 10],
        "aux_files": ["LORIP45V3_UTCX_scaled_out.obj", "LORIP45V2_CX.stl", "LORIP45V3_UTCX_scaled_in.obj"],
        "opt_mesh_idx": 0,
        "remesh_reload_function": lambda fname: make_selections.make_selections(fname, "LORIP45V2_CX.stl"),
        "threads": 16
    }
...
def do_tetwild_remesh(remesh_reload_function, ftetwild_build_dir, base_path, edge_length=None):
...
def main():
    ...
    edge_length = args.remesh_edge_length
...
if __name__ == "__main__":
    ...
    parser.add_argument("--remesh_edge_length",
                        type=float,
                        help="edge length for remeshing")
